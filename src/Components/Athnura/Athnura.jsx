  ...
  return (
    <>
      <div className='flex  flex-col justify-center text-center bg-[#FBF9F5] p-[12px]'>
        ...
        <button className='bg-[#556e41] flex justify-center w-[138px] h-auto p-[7px] items-center  m-auto rounded-3xl text-white hover:bg-[#435037] cursor-pointer'onClick={()=>window.open('https://www.athenura.in')}>
VISIT ATHNURA
        </button>
      </div>
    </>
